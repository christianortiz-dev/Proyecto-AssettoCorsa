...
public class UI_Vuelta {
    ...
    public void mostrarMenu() {
        ...
        while (!salir) {
            // Colores aplicados para el estilo del menú
            ...
            if (scanner.hasNextInt()) {
                ...
                // Manejo de error cuando la entrada no es numérica
    ...
    private void leerVuelta() {
        ...
        if (vuelta != null) {
            System.out.println("Vuelta encontrada - ID: " + vuelta.getId() + "\n Tiempo: " + vuelta.getTiempo()
                    ...
                    + "\n Coche: " + vuelta.getCoche().getMarca() + " " + vuelta.getCoche().getModelo() + " "
    ...
    private void listarVueltas() {
        ...
        for (Vuelta vuelta : vueltas) {
            System.out.println("╔═══════════════════════════════════════════════╗" + "\n║ Vuelta con ID: " + vuelta.getId()
                    + "\n║ Tiempo: " + vuelta.getTiempo() + "\n║ Piloto: " + vuelta.getPiloto().getNombre() + " "
                    + vuelta.getPiloto().getApellido() + "\n║ Coche: " + vuelta.getCoche().getMarca() + " "
                    + vuelta.getCoche().getModelo() + " " + vuelta.getCoche().getPotencia() + "cv" + "\n║ Circuito: "
                    + vuelta.getCircuito().getNombre() + ", " + vuelta.getCircuito().getLocalizacion() + " ("
                    + vuelta.getCircuito().getLongitud() + " km)"
                    + "\n╚═══════════════════════════════════════════════╝");
        }
    }
    ...
    private void actualizarVuelta() {
        ...
        if (vuelta != null) {
            ...
            while (!salir) {
                ...
                switch (opcion) {
                    case 1:
                        System.out.print("Ingrese el nuevo tiempo (MM:SS:DDD): ");
                        ...
                        break;
                    case 2:
                        System.out.print("Ingrese el nuevo ID del piloto: ");
